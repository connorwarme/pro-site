...
<img src={barnacle.src} alt="Amity stemming the crux of Barnacle Scars on Ship's Prow" />
...
<img src={barn1.src} alt="Amity on Barnacle Scars (5.13) on Ship's Prow" />
...
<img src={honey.src} alt="Amity after sending The Honeymoon is Over" />