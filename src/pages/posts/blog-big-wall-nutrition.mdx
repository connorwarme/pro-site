...
<img src={fuel.src} alt="Planning out each day's snacks" />
...
<img src={fuel1.src} alt="Amity enjoying dinner on the G7 portaledge" />
...
<img src={fuel3.src} alt="Amity planning out meals for El Cap adventure" />
The meals from Right On Trek for my adventure on El Niño with Brent Barghahn.  
<img src={fuel2.src} alt="Amity planning out all their food for Golden Gate" />
